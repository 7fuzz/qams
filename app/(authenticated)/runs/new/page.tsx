...
import { Search, CheckSquare, Square, Layers, LayoutPanelTop, Play, FileText, Calendar, CheckCircle2 } from 'lucide-react';
    ...
    <div className="container mx-auto p-4 md:p-8 max-w-6xl text-text-theme-main">
      <div className="flex flex-col gap-8">
        <div className="space-y-1">
          ...
          <p className="text-text-theme-muted font-medium uppercase tracking-widest text-[10px]">Define scope and select modules for this execution cycle.</p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="space-y-6">
                <Card className="shadow-sm border-border-theme">
                    ...
                    <CardFooter className="bg-surface-muted/30 border-t border-border-theme pt-6">
                        <Button 
                        ...
                        >
                            {loading ? 'Initializing...' : <><Play size={16} className="mr-2" /> Start Run</>}
                        </Button>
                    </CardFooter>
                </Card>
            </div>
